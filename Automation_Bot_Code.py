...
drivetrain = DriveTrain(Motor_Group_1, Motor_Group_3, 319.19, 295, 40, MM, 1)
Motor_Group_7_motor_a = Motor(Ports.PORT6, GearSetting.RATIO_18_1, True)
Motor_Group_7_motor_b = Motor(Ports.PORT7, GearSetting.RATIO_18_1, False)
